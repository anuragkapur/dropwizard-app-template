package com.ft.membership.appName;

import com.ft.membership.appName.health.HelloWorldHealthCheck;
import com.ft.membership.appName.resources.HelloWorldResource;
...
public class App extends Application<AppConfig> {
    ...
    private static String[] getDefaultedArgs(String[] args) {
        ...
        if (args.length == 0) {
            ...
            try {
                yamlPath = new File(Resources.getResource("com/ft/membership/appName/local-dev.yaml").toURI()).getAbsolutePath();
